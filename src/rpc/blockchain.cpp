                ...
                },
                {
                    RPCResult{"for verbose = true",
                        RPCResult::Type::OBJ, "", "",
                        {
                            ...
                            {RPCResult::Type::STR_AMOUNT, "moneysupply", "The total amount of rhombus in the chain at this block"},
                        ...
                        {RPCResult::Type::OBJ, "scriptPubKey", "",
                            {
                                ...
                                {RPCResult::Type::ARR, "addresses", "array of rhombus addresses",
...
static UniValue getblockstats(const JSONRPCRequest& request)
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            const auto& txundo = blockUndo.vtxundo.at(fRhombusMode ? i : i - 1); // Rhombus includes coinbase/coinstake in undo data
