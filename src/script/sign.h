...
public:
    ...
    virtual bool IsRhombusVersion() const { return false; }
...
public:
    ...
    bool IsRhombusVersion() const override { return txTo && txTo->IsRhombusVersion(); }
...
extern const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_RHOMBUS;
