...
public:
    CMainParams() {
        ...
        base58Prefixes[EXT_PUBLIC_KEY]     = {0x03, 0xe3, 0x0b, 0xcf}; // prom
        base58Prefixes[EXT_SECRET_KEY]     = {0x04, 0x89, 0x60, 0x6f}; // xrom
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        checkpointData = {
            {
                //{0, uint256S("0x0000031f198ba1cb4889b7dfa54abe05cd316549ea6917d7d0984570ef680ff8")},
            }
        };
