...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName, const std::vector<const char*>& extra_args, bool fRhombusModeIn)
    ...
    const std::vector<const char*> arguments = Cat(
        {
            ...
            fRhombusMode ? "" : "-btcmode",
            fRhombusMode ? "-debugexclude=hdwallet" : "",
        },
        extra_args);
...
TestingSetup::TestingSetup(const std::string& chainName, const std::vector<const char*>& extra_args, bool fRhombusModeIn)
    : BasicTestingSetup(chainName, extra_args, fRhombusModeIn)
{
