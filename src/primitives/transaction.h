...
static const uint8_t RHOMBUS_BLOCK_VERSION = 0xA0;
static const uint8_t RHOMBUS_TXN_VERSION = 0xA0;
static const uint8_t MAX_RHOMBUS_TXN_VERSION = 0xBF;
...
{
    return (nVersion & 0xFF) >= RHOMBUS_TXN_VERSION;
}
...
public:
    ...
    static const int32_t CURRENT_RHOMBUS_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_RHOMBUS_VERSION=0xA0;
