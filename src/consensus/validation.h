...
public:
    ...
    void SetStateInfo(int64_t time, int spend_height, const Consensus::Params& consensusParams, bool rhombus_mode, bool skip_rangeproof)
    {
