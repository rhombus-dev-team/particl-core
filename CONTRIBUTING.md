Contributing to Rhombus Core
============================

The Rhombus project operates an open contributor model where anyone is
...
Most communication about Rhombus development happens on [#rhombus-dev:matrix.org](https://riot.im/app/#/room/#rhombus-dev:matrix.org), in the Rhombus Open Development channel on Riot. The easiest way to participate on Riot is
...
The following applies to code changes to the Rhombus project..

Whether a pull request is merged into Rhombus Core rests with the project merge
...
Patches that change Rhombus consensus rules are considerably more involved than
...
[//]: # (Where a patch set proposes to change the Rhombus consensus, it must have been
...
The project leader is the release manager for each Rhombus Core release.
