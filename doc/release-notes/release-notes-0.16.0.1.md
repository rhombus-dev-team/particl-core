...
Note, Legacy Stealth Addresses are not supported on Hardware Signing Devices. If you have RHOMtPART received on the Legacy Stealth Addresses then we suggest you send those RHOMtPART to a non-Stealth Address before attempting to use with the Hardware Signing Devices.
