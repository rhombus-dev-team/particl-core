...
class TestNode():
    ...
    def __init__(self, i, datadir, *, chain, rpchost, timewait, factor, bitcoind, bitcoin_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False):
        ...
        self.bitcoinconf = os.path.join(self.datadir, "rhombus.conf")
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, **kwargs):
        ...
        if kwargs.pop('btcmode', True):
            extra_args.insert(0, '-btcmode')  # Can't append options, BitcoinTestFramework::setup_nodes expects the last option to be -nowallet
